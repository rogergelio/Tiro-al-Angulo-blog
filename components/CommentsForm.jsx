...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-theme-black shadow-lg rounded-lg p-8 pb-12 mb-4 text-white">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-100 cursor-pointer" htmlFor="storeData"> Guardar mi nombre e información en el navegador para la próxima vez que comente.</label>
        </div>
      </div>
      {error && <p className="text-xs text-red-500">¡Por favor llena todos los campos!</p>}
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-green bg-dark-green inline-block bg-dark-green-600 text-lg font-medium rounded-full text-neutral-200 px-8 py-3 cursor-pointer">Publicar Comentario</button>
