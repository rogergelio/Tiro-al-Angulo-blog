...
export default function WelcomeCard({ posts }) {
  ...
  return (
        <div className="h-85v w-full m-auto relative lg:col-span-12 col-span-1 group overflow-hidden">
          <div
            style={{
          ...
          <div className="hidden group-hover:block text-white absolute top-[35%] -translate-x-0 translate-y-[50%] left-5 text-2xl p-2 cursor-pointer z-10">
            <BsChevronCompactLeft onClick={prevSlide} size={"60px"} />
          </div>
          <div className="hidden group-hover:block text-white absolute top-[35%] -translate-x-0 translate-y-[50%] right-5 text-2xl p-2 cursor-pointer z-10">
          ...
          <div className="text-center -translate-y-35v">
            <div className="text-white text-l mx-32 my-4">
          ...
          <div className="text-center -translate-y-70v whitespace-normal">
            <div className="text-white text-4xl font-bold mx-32 my-4">
              {posts[currentIndex].node.title}
            </div>
            <div className="text-white text-xl mx-32">
